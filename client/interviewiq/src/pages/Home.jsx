...
import { BsRobot,BsMic, BsClock, BsBarChart, BsFileEarmarkText, BsFileEarmark } from "react-icons/bs"
...
import analyticImg from "../assets/history.png"
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-28">
          {
            [
              ...
              transition-all duration-300 ${index===0}? "rotate-[-4deg]":""}
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {
                [
                  ...
                  },
                  {
                    ...
                    desc:"Projec-specific questions based on uploaded resume."
                  },
                  {
                    image:pdfImg,
                    icon:<BsFileEarmarkText size={20} />,
                ...
                className="bg-white border border-gray-200 rounded-3xl shadow-sm hover:shadow-xl transition-all">
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="bg-green-50 text-green-600 w-12 h-12 rounded-xl flex flex-row items-center justify-center mb-6">
                     {item.icon} </div>
                     <h3 className="font-semibold mb-3 text-xl flex justify-center items-center ">{item.title}

                     </h3>
                     <p className="text-gray-500 text-sm leading-relaxed flex justify-center items-center mb-6 ">
                      {item.desc}
                     </p>
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {
                ...
                className="bg-white border border-gray-200 rounded-3xl shadow-sm hover:shadow-xl transition-all">
                  <div className="flex items-center justify-between gap-6">
                    <div className="w-1/2">
                    <h3 className="font-semibold text-xl mb-3 flex justify-center items-center mt-2">
                      {mode.title}
                    </h3>
                    <p className="text-gray-500 text-sm leading-relaxed ml-5 mb-5 ">
                      {mode.desc}
                    </p>
                  </div>
                  ...
                  <img src={mode.image}
                  alt={mode.title}
                  className="w-28 object-container" /></div>
                  </div>
